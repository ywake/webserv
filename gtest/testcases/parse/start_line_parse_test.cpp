...
TEST(start_line, whitespace)
{
	...
	ASSERT_EQ(error, ParseErrorException());
}
*/
...
{
	EXPECT_THROW(RequestLine(""), ParseErrorException);
	EXPECT_THROW(RequestLine(" "), ParseErrorException);
	EXPECT_THROW(RequestLine("  "), ParseErrorException);
	EXPECT_THROW(RequestLine("   "), ParseErrorException);
	EXPECT_THROW(RequestLine("    "), ParseErrorException);
	EXPECT_THROW(RequestLine("GET"), ParseErrorException);
	EXPECT_THROW(RequestLine("GET "), ParseErrorException);
	EXPECT_THROW(RequestLine("GET  "), ParseErrorException);
	EXPECT_THROW(RequestLine("GET   "), ParseErrorException);
	EXPECT_THROW(RequestLine(" GET"), ParseErrorException);
	...
	EXPECT_THROW(RequestLine(" GET /"), ParseErrorException);
	EXPECT_THROW(RequestLine("GET / "), ParseErrorException);
	EXPECT_THROW(RequestLine("GET HTTP/1.1"), ParseErrorException);
	EXPECT_THROW(RequestLine("GET  HTTP/1.1 "), ParseErrorException);
	EXPECT_THROW(RequestLine("GET  HTTP/1.1"), ParseErrorException);
	EXPECT_THROW(RequestLine("GET   HTTP/1.1"), ParseErrorException);
	EXPECT_THROW(RequestLine("GET  HTTP/1.1 "), ParseErrorException);
	...
	EXPECT_THROW(RequestLine(" GET  /  HTTP/1.1 "), ParseErrorException);
	EXPECT_THROW(RequestLine("GET/HTTP/1.1"), ParseErrorException);
	EXPECT_THROW(RequestLine("GET_/_HTTP/1.1"), ParseErrorException);
	EXPECT_THROW(RequestLine("GET / HTTP/42.42"), ParseErrorException);
}
